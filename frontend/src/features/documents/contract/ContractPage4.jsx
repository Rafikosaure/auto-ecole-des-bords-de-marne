...
export default function ContractPage4({ currentPageNumber, student }) {
    const { register, watch } = useFormContext()

    const pageDisplay = currentPageNumber === 4 ? 'block' : 'none'

    const initialsPage4 = watch('fileData.studentContractData.initialsOptions.ifInitialed_page4')
  ...
  return (
    <div className='wrapper' style={{ display: `${pageDisplay}` }}>
        ...
        <div className="initials"><input type="checkbox" className='input-checkbox' {...register('fileData.studentContractData.initialsOptions.ifInitialed_page4')} /> <strong>Initiales:</strong>
            {initialsPage4 ? (
