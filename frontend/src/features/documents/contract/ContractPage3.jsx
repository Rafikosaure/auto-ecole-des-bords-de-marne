...
export default function ContractPage3({ currentPageNumber, student }) {
    const { register, watch } = useFormContext()

    const pageDisplay = currentPageNumber === 3 ? 'block' : 'none'

    const initialsPage3 = watch('fileData.studentContractData.initialsOptions.ifInitialed_page3')
    const pricePerMonth = watch('formationData.formationPrices.Theorie.packwebAppAccessCodePrices.pricePerMonth')
    const priceForFourMonths = watch('formationData.formationPrices.Theorie.packwebAppAccessCodePrices.priceForFourMonths')
    ...
    <div className='wrapper' style={{ display: `${pageDisplay}` }}>
        ...
        <div className="section">
          ...
          <div className="checkboxes">
            ...
            <div className="checkbox-section-element"><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.theoricalFormation.location.onSite')} /><label style={{ marginLeft: '1px' }}>Sur place</label></div>
            <div className="checkbox-section-element"><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.theoricalFormation.location.remote')} /><label style={{ marginLeft: '1px' }}>À distance</label></div>
            <div className="checkbox-section-element"><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.theoricalFormation.location.onSiteAndRemote')} /><label style={{ marginLeft: '1px' }}>Les deux</label></div>
            <div className="checkbox-section-element"><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.theoricalFormation.location.individualCourses')} /><label style={{ marginLeft: '1px' }}>En cours individuel</label></div>
            <div className="checkbox-section-element"><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.theoricalFormation.location.groupCourses')} /><label style={{ marginLeft: '1px' }}>En cours collectif</label></div>
          </div>
        </div>
        <div className="section">
          <h4>1.3 Moyens pédagogiques et techniques</h4>
          <p><strong>Soit : </strong>à distance via l'application PACKWEB 2, un login vous sera fourni ({pricePerMonth}/mois ou {priceForFourMonths}/4 mois).</p>
        ...
        <div className="section">
          ...
          <div style={{display: 'flex', flexDirection: 'column', width: '100%', alignItems: 'baseline', gap: '15px'}}>
            <div style={{display: 'flex'}}>
              ...
              <div className="checkbox-section-element" style={{marginLeft: '22px'}}><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.practicalFormation.location.openWayWithAnInstructor')} /><label style={{ marginLeft: '5px' }}>Sur voies ouvertes à la circulation avec un enseignant. En cours
                  individuel.</label></div>
            </div>
            <div style={{display: 'flex', gap: '100px'}}>
              <div className="checkbox-section-element"><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.practicalFormation.location.manualTransmission')} /><label style={{ marginLeft: '5px' }}>Sur
                  boîte manuelle</label></div>
              <div className="checkbox-section-element"><input type="checkbox" className='input-checkbox' {...register('formationData.formationType.practicalFormation.location.automaticTransmission')} /><label style={{ marginLeft: '5px' }}>Sur
        ...
        <div className="initials"><input type="checkbox" className='input-checkbox' {...register('fileData.studentContractData.initialsOptions.ifInitialed_page3')} /> <strong>Initiales:</strong>
            {initialsPage3 ? (
