  ...
  return (
    <div className='wrapper' style={{ display: `${pageDisplay}` }}>
        ...
        <div className="checkboxes" style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '2px'}}>
            <div className="checkbox-section-element"><input type="checkbox" className="input-shaping input-checkbox" defaultChecked={data.formationData.formationPrices.paymentOptions.withDepositAndBalance.isChecked} onChange={(e) => setFormationPricesPaymentOptionWithDepositAndBalance(e.target.checked)} /><label style={{ marginLeft: '2px' }}>1 - avec des arrhes et le solde d'un montant de <input type="text" className='input-type-text' style={{ width: '50px' }} defaultValue={data.formationData.formationPrices.total.MontantTTC} onChange={(e) => setTotalFormationPrices(e.target.value)} /> € devant être réglé le <input type="text" className='input-type-text' style={{ width: '80px' }} defaultValue={`${data.formationData.formationPrices.paymentOptions.withDepositAndBalance.paymentDate.paymentDay}/${data.formationData.formationPrices.paymentOptions.withDepositAndBalance.paymentDate.paymentMonth}/${data.formationData.formationPrices.paymentOptions.withDepositAndBalance.paymentDate.paymentYear}`} onChange={(e) => setFormationPricesPaymentOptionWithDepositAndBalancePaymentDate(e.target.value)} /></label></div>
