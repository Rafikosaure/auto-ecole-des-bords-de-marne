...
// src/pages/AdminPage.jsx ajouter l'email dans le render 
  ...
  return (
    <div className="container mt-5 admins-container">
      ...
      <table className="table table-striped">
        <thead>
          <tr>
            <th className="text-center">Nom d'utilisateur</th> {/* Centré */}
            <th className="text-center">Email</th> {/* Nouvelle colonne pour l'email */}
        ...
        <tbody>
          {admins.map((admin) => (
            <tr key={admin.id}>
              ...
              <td className="text-center">{admin.email}</td> {/* Affichage de l'email */}
