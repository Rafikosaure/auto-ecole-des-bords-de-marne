// VERSION DEFINITIVE A PUSHER 


import React, { useState, useEffect, useRef } from 'react';
import { useParams } from 'react-router-dom'; // Retirer navigate si non utilisé
...
// // FICHIER BON FONCTION LE BON OKK TOUT FONCTIONNE !!!!!
...
// // VERSION QUI AFFICHE BIEN LA MODAL DES FICHIERS PNG  CA MARCHE MAIS IL OUVRE BIEN LA MODAL POUR LES DOC PDF 
// // MAIS EN MEME TEMPS IL OUVRE LA FENETRE POUR UPLOADER DES DOC IL NE FAIS PAS DANS LA FENETRE 
// // IL FAUT SEPARER LES DEUX 
...
//     // Récupération des informations de l'instructeur et des documents associés
//     useEffect(() => {
//         if (!id) {
//             setError("ID de l'instructeur manquant dans les paramètres de l'URL.");
//             setLoading(false);
...
//     // Fonction pour récupérer les documents de l'instructeur
//     const fetchDocuments = async () => {
//         try {
//             const response = await apiClient.get(`/instructor/get/${id}`);
//             setDocuments(response.data.documents || []);
...
//     // Fonction pour gérer la suppression des documents
//     const handleDelete = async (documentId) => {
//         if (!window.confirm("Êtes-vous sûr de vouloir supprimer ce document ?")) {
//             return;
//         }
...
//     // Fonction pour ouvrir la modale avec le document sélectionné
//     const openDocument = (document) => {
//         setSelectedDocument(document);
//     };
...
//     // Fonction pour ouvrir l'input file
//     const openFileInput = (type) => {
//         cardRefs.current[type]?.click();  // Déclenche l'événement de clic sur l'élément input caché
//     };
...
//     // Affichage des cartes pour chaque type de document
//     const displayCards = cardTypes.map((type) => {
//         const document = documents.find((doc) => doc.type === type);
...
//                 key={type}
//                 style={{ cursor: 'pointer' }}
//                 onClick={() => document && openDocument(document)} // Clic sur la carte ouvre la modale
//             >
//                 <div className="card" style={{ border: '1px solid black', borderRadius: '5px' }}>
//                     <div className="card-body" style={{ padding: '0px' }}>
//                         <h5
...
//                                 openFileInput(type);  // Ouvre le sélecteur de fichier
//                             }}
//                         >
//                             {type}
//                         </h5>
